...
$subject ="Новая заявка с сайта Event site";
...
$header .= "From: Новая заявка <gbrattsev@gmail.com>\n\n";	
$mail = mail("gbrattsev@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
